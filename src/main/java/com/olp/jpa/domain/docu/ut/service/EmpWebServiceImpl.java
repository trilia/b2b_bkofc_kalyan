...
import com.olp.jpa.domain.docu.ut.EmployeeService;
...
@WebService(serviceName="EmpService", 
        endpointInterface="com.olp.jpa.domain.docu.ut.service.EmpWebService", 
        targetNamespace="http://trilia-cloud.com/webservices/entity/ut/ut-emp-service",
        portName="EmpService_Port"
        )
@Path("/employees")
public class EmpWebServiceImpl implements EmpWebService {
    ...
    public EmpBeanPub add(EmpBeanPub emp) throws ServiceException {
        ...
        if (emp == null) {
            ServiceException se = FaultUtil.makeServiceException("Null employee parameter received", new IllegalArgumentException("Null employee parameter received !"));
            throw se;
        }
        
        if (emp.getEmployeeNumber() == null) {
            ServiceException se = FaultUtil.makeServiceException("Null employee parameter received", new IllegalArgumentException("Null employee code attribute received !"));
            throw se;
        }
    ...
    public EmpBeanPub update(EmpBeanPub emp) throws ServiceException {
        ...
        if (emp == null) {
            ServiceException se = FaultUtil.makeServiceException("Exception occured in update service", new IllegalArgumentException("Null employee parameter received !"));
            throw se;
        }
        if (emp.getId() == null || emp.getId() <= 0) {
            ServiceException se = FaultUtil.makeServiceException("Exception occured in update service", new IllegalArgumentException("Null or invalid employee id"));
            throw se;
        }
        ...
        try {
            ...
            ServiceException se = FaultUtil.makeServiceException("Exception occured in update service while fetching employee object with id " + emp.getId(), t);
            throw se;
        }
        
        if (bean == null) {
            ServiceException se = FaultUtil.makeServiceException("Exception occured in update service - null employee object", new IllegalArgumentException("No employee with id " + emp.getId() + " exists !"));
            throw se;
        }
        
        if (!bean.getEmployeeNumber().equals(emp.getEmployeeNumber())) {
            ServiceException se = FaultUtil.makeServiceException("Exception occured in update service - id & code mismatch", new IllegalArgumentException("No employee with code " + emp.getEmployeeNumber() + " exists for id " + emp.getId()));
            throw se;
        }
        ...
        try {
            ...
            ServiceException se = FaultUtil.makeServiceException("Exception occured in update service while updating employee object with id " + emp.getId(), t);
            throw se;
        }
    ...
    public void delete(@PathParam("empId") Long id) throws ServiceException {
        ...
        if (id == null || id <= 0) {
            ServiceException se = FaultUtil.makeServiceException("Exception occured in delete service", new IllegalArgumentException("Null employee id parameter received !"));
            throw se;
        }
        ...
        try {
            ...
            ServiceException se = FaultUtil.makeServiceException("Exception occured in delete service while deleting employee with id " + id, t);
            throw se;
        }
    ...
    public void delete(@PathParam("empCode") String empCode) throws ServiceException {
        ...
        if (empCode == null || "".equals(empCode)) {
            ServiceException se = FaultUtil.makeServiceException("Exception occured in delete service", new IllegalArgumentException("Null employee code parameter received !"));
            throw se;
        }
        ...
        try {
            ...
            ServiceException se = FaultUtil.makeServiceException("Exception occured in delete service while deleting employee with code " + empCode, t);
            throw se;
        }
        
        if (bean == null) {
            ServiceException se = FaultUtil.makeServiceException("Exception occured in delete service - null employee object", new IllegalArgumentException("No employee with code " + empCode + " exists !"));
            throw se;
        }
    ...
    @Override
    @Transactional(readOnly=true)
    public List<EmpBeanPub> doSimpleSearch(String keywords, Boolean fuzzy, SortCriteriaBean sort, Integer outputMode) throws ServiceException {
    ...
    public List<EmpBeanPub> doSimpleSearch(@QueryParam("q") String keywords, @QueryParam("fuzzy") Boolean fuzzy, 
            @QueryParam("asc") List<String> ascFields, @QueryParam("desc") List<String> descFields, @QueryParam("outputMode") Integer outputMode) throws ServiceException {
    ...
    @Override
    @Transactional(readOnly=true)
    public PageResponseBean<EmpBeanPub> doSimpleSearch(String keywords, Boolean fuzzy, Integer outputMode, PageRequestBean request) throws ServiceException {
    ...
    @GET
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    public PageResponseBean<EmpBeanPub> doSimpleSearch(
            @QueryParam("q") String keywords, @QueryParam("fuzzy") Boolean fuzzy, @QueryParam("outputMode") Integer outputMode,
            @QueryParam("page") Integer pageNum, @QueryParam("pageSize") Integer pageSize,
            @QueryParam("asc") List<String> ascFields, @QueryParam("desc") List<String> descFields) throws ServiceException {
    ...
    @Override
    @Transactional(readOnly=true)
    public List<EmpBeanPub> doAdvancedSearch(SearchCriteriaBean search, SortCriteriaBean sort, Integer outputMode) throws ServiceException {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    @Transactional(readOnly=true)
    public PageResponseBean<EmpBeanPub> doAdvancedSearch(SearchCriteriaBean search, Integer outputMode, PageRequestBean request) throws ServiceException {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    
    @Override
    @Transactional(readOnly=true)
    public PageResponseBean<EmpBeanPub> findAll(Integer outputMode, PageRequestBean request) throws ServiceException {
    ...
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    @Consumes({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    public List<EmpBeanPub> addAll(List<EmpBeanPub> list, boolean ignoreError, Integer outputMode) throws ServiceException {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            try {
                ...
                if (ignoreError) {
                    Logger.getLogger(getClass().getName()).log(Level.SEVERE, "Exception encountered while adding employee with code " + bean.getEmployeeNumber(), t);
                } else {
                    ServiceException se = FaultUtil.makeServiceException("Exception occurred in addAllEmp service for employee code " + bean.getEmployeeNumber(), t);
                    throw se;
                }
            }
    ...
    @Override
    @Transactional
    public Future<?> addAllAsync(List<EmpBeanPub> list, boolean ignoreError, Integer outputMode, final AsyncHandler<List<EmpBeanPub>> asyncHandler) throws ServiceException {
    ...
    @Override
    public Future<?> updateAllAsync(List<EmpBeanPub> list, boolean ignoreError, Integer outputMode, final AsyncHandler<List<EmpBeanPub>> asyncHandler) throws ServiceException {
        return(null);
    }
    
    @Override
    public Response updateAllAsync(List<EmpBeanPub> list, boolean ignoreError, Integer outputMode) throws ServiceException {
        return(null);
    }
