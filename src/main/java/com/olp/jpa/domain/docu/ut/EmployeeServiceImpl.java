 ...
 */
@Service("empService")
//@WebService(serviceName = "EmployeeService", endpointInterface="com.olp.jpa.domain.docu.ut.EmployeeService", targetNamespace="http://trilia-cloud.com/webservices/entity/ut/ut-employee-service/")
//@Path("/employees")
